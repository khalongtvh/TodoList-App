                ...
                <div class="card-body">
                  <form action="{{route('customers.store')}}" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3 mb-md-0">
                          <input name="confirm_pass" id="confirm_pass" class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" required />
                    ...
                    <div class="mt-4 mb-0">
                      ...
                      <div class="d-grid"><input class="btn btn-primary btn-block" type="submit" name="register" value="Create Account" /></div>
